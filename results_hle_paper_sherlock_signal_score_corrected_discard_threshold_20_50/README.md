# Corrected discard threshold replication

This 50-game replication raises `HANABI_DISCARD_MIN_PLAY_PROBABILITY` from
0.10 to 0.20 while retaining the corrected one-action clue criterion and all
...
The result is a promising candidate relative to the corrected 200-game mean of
