# JEV Sherlock Score baseline, 100 games

This is the version of the current best policy. Clues that make
...
The criterion produces the best complete mean so far, but its direct
